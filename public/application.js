...
(function() {
  ...
  Asset = (function(_super) {
    ...
    Asset.prototype.query = function(params, property) {
      var prop, q, val, value, _i, _len, _ref;
      if (property == null) {
        property = void 0;
      }
      _ref = this.meta;
      for (prop in _ref) {
        ...
        value = this._normalizeValue(val.value);
        if (!value) {
          continue;
        }
        for (_i = 0, _len = params.length; _i < _len; _i++) {
          ...
          if (typeof value === "number") {
            if (parseFloat(q) !== value) {
              continue;
            }
            return true;
          }
          if ((typeof value.indexOf === "function" ? value.indexOf(q) : void 0) !== -1) {
            return true;
          }
        }
      }
    ...
    Asset.prototype.upvote = function() {
      ...
      successResponse = (function(_this) {
        return function(data, status, xhr, options) {
          return console.log('likes +1', _this.meta.likes.value);
        };
      })(this);
      ...
      return $.ajax({
        ...
        return console.log('error while upvoting');
      });
    };
...
//# sourceMappingURL=jquery.viewport.map
    ...
    Slide.prototype.render = function(result) {
      ...
      if (assets.length && this.subslides) {
        ...
        this.add(this["media"] = new Nex.Widgets[kind]({
          ...
          sizemode: result.getMeta('sizemode', [this.sizemode])[0],
          height: this.height,
          width: this.width,
          noResize: this.noResize,
          lazy: this.lazy
        ...
        if (typeof this.enablehtml === 'boolean' && this.enablehtml) {
          ...
          html = result.getMeta('text', result.getMeta(this.enablehtml, ''));
        } else if (typeof this.enablehtml === 'function') {
          html = this.enablehtml(result);
        }
        if (html) {
